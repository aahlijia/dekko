...
Generated by dekko on 2026-06-16 17:50 UTC. Do not edit by hand.
...
**95** files (python 83, c 2, javascript 2, rust 2, bash 1, cpp 1, go 1, java 1, ruby 1, typescript 1) · **1024** functions/methods · **54** classes · **1946** call edges (174 ambiguous, 1870 external — see map.json)

*Mapped 95 files in 246 ms (cache: 0 reused / 95 parsed).*

## Overview

| Directory | Files | Symbols | Internal | Cross-dir | Purpose |
|---|--:|--:|--:|--:|---|
| `src/dekko/` | 34 | 538 | 913 | 524 | dekko: static code map generator (MAP.md + map.json). |
| `tests/` | 46 | 481 | 450 | 520 | Shared pytest configuration. |
...
- [`make_mapped_repo(tmp_path: Path) -> RepoFactory`](map/tests.md#tests-conftest-py-make-mapped-repo) — 171
...
|---|--:|--:|--:|
| [`src/dekko/cli.py`](map/src-dekko.md#src-dekko-cli-py) | 5 | 189 | 5.0 |
| [`tests/conftest.py`](map/tests.md#tests-conftest-py) | 5 | 171 | 4.5 |
| [`src/dekko/server.py`](map/src-dekko.md#src-dekko-server-py) | 5 | 116 | 3.1 |
| [`src/dekko/render_lean.py`](map/src-dekko.md#src-dekko-render-lean-py) | 4 | 100 | 2.1 |
| [`src/dekko/textutil.py`](map/src-dekko.md#src-dekko-textutil-py) | 4 | 94 | 2.0 |
| [`src/dekko/mapfile.py`](map/src-dekko.md#src-dekko-mapfile-py) | 2 | 104 | 1.1 |
...
| [`tests/test_server.py`](map/tests.md#tests-test-server-py) | 7 | 28 | 1.0 |
...
- **tests/**
  ...
  - [`test_ledger.py`](map/tests.md#tests-test-ledger-py) (17 symbols) — Pillar C read side: the transcript-projected session ledger.
